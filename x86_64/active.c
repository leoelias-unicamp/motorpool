...
extern Memb_func* memb_func;
 ...
 "setdata_active", _hoc_setdata,
 "rates_active", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define ptau_active _thread1data[0]
#define ptau _thread[_gth]._pval[0]
#define pinf_active _thread1data[1]
#define pinf _thread[_gth]._pval[1]
#define usetable usetable_active
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_active", 0, 1e+09,
 "gcabar_active", 0, 1e+09,
 "usetable_active", 0, 1,
 0,0,0
};
 ...
 "pinf_active", &pinf_active,
 "ptau_active", &ptau_active,
 "usetable_active", &usetable_active,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 4);
 	...
 	ivoc_help("help ?1 active /Users/leonardo/Dropbox/SharedUbuntu/workspace/network/x86_64/active.mod\n");
...
static int _reset;
static char *modelname = "active.mod";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _ltheta_p , _lk_p ;
  _ltheta_p = theta ;
   _lk_p = - 7.0 ;
   ptau = 20.0 ;
   pinf = 1.0 / ( 1.0 + exp ( ( _lv - _ltheta_p ) / _lk_p ) ) ;
    return 0; }
